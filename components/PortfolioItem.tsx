        ...
        <div className='box'>
            ...
            <div className='relative w-full h-80 rounded-lg overflow-hidden group cursor-pointer mb-5'>
                ...
                <div className='bg-black bg-opacity-10 backdrop-blur-[1px] absolute top-0 left-0 w-full h-full opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center'>
                    <Link href={portfolio.link} target="_blank" className='w-16 h-16 flex items-center justify-center bg-beach-700 border bg-peach-700 p-3 text-grey rounded-lg'>
                        <ArrowUpRight />
                    </Link>
                </div>
            </div>
            ...
            <div className='grid grid-cols-3 gap-3'>
                {portfolio.images.map((image, index) => (
                    ...
                    >
                        ...
                        <div className={`bg-black bg-opacity-10 backdrop-blur-[1px] absolute top-0 left-0 w-full h-full opacity-0 group-hover:opacity-100 transition-opacity duration-300 ${currentImg !== image ? "opacity-100" : "opacity-0"}`}></div>
                    </div>
                ))}
            </div>
        </div>
